...
<center><img src="sit.png" width="150" height="150">
<img src="logosit.jpeg" align="right"  width="150" height="150"></center>
...
body{
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>institution Name: Silicon Institue Of Technology</th>
  ...
  <table>
    ...
    <tfoot>
      <tr>
        ...
        <td>560</td>
        <td>180</td>
        <td><%float sum=rs.getInt(8)+rs.getInt(9)+rs.getInt(10)+rs.getInt(11)+rs.getInt(12)+rs.getInt(13)+rs.getInt(14);out.println(sum); %> </td>
      </tr>
      <tr>
...
Designed & Developed by Twinkle Keshri and CO.</h6></center>
  <hr class="new1">
<center><h6><span> &copy;</span>2021 Twinkle Keshri(EEE,2018-22),All rights reserved</h6></center> 
  <hr class="new1">
</body>
<%}
else
